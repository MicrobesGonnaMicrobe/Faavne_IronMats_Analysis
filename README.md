...
Faavne_M6_B19.fna.gz	Faavne_M6_B19
...
```

3. Create a tab separated file for the taxonomic classification of each species. Real classification is not really needed for this, it is enough to provide the species and superkingdom and put "." for the rest. Provide this file in place of species_taxonomic.txt. Follow the format below:
```
species superkingdom    phylum  class   order   family
Faavne_M6_B18	Bacteria	.	.	.	.
Faavne_M6_B19	Bacteria	.	.	.	.
```
...
```
    python3 ~/OGT_prediction/OGT_prediction/prediction/prediction_pipeline.py regression_models_Bacteria_uncultivated/ genomes_retrieved.txt species_taxonomic.txt
```
